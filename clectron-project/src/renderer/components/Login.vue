<template>
    <div>
        <form id="slick-login" ref="form" :model="login_form">
            <label for="username">username</label><input type="text" name="username" class="placeholder" placeholder="example@xx.com" v-model="login_form.email">
            <label for="password">password</label><input type="password" name="password" class="placeholder" placeholder="password" v-model="login_form.password">
            <input type="submit" value="Log In" @click="onLoginSubmit">
        </form>
    </div>
</template>
